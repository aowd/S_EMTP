...
Idc_PSC_filter = filter(Num_ac,1,result_PSC(:,38));
Idc_CPP_filter = filter(Num_ac,1,result_CPP(:,38));
figure(10)
...
Pr2_PSC_filter = filter(Num_ac,1,Pr2_PSC);
Pr2_CPP_filter = filter(Num_ac,1,Pr2_CPP);
figure(18)
...
figure(22)
plot(t,Pr_PSC,t,Pr2_PSC_filter)

figure(23)
plot(t,Pr_CPP,t,Pr2_CPP_filter)

figure(24)
plot(t,result_CPP(:,18))