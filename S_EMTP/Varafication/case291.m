...
%% 选择需要观察的波形
Udc_PSC = result_PSC(:,7)-result_PSC(:,8);
Udc_CPP = result_CPP(:,7)-result_CPP(:,8);

% Iabc_PSC = result_PSC(:,15:17);
% Iabc_CPP = result_CPP(:,15:17);

Iabc_PSC = result_PSC(:,18:20);
Iabc_CPP = result_CPP(:,18:20);

% Iabc_PSC = result_PSC(:,4:6);
% Iabc_CPP = result_CPP(:,4:6);
