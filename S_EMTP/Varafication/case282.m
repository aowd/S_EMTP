...
Udc_PSC = result_PSC(:,15);
Udc_CPP = result_CPP(:,15);
...
i0_PSC2 = (1/3)*(Iabc_PSC(:,1)+Iabc_PSC(:,2)+Iabc_PSC(:,3));
i0_CPP2 = (1/3)*(Iabc_CPP(:,1)+Iabc_CPP(:,2)+Iabc_CPP(:,3));
figure(7)
plot(t,i0_PSC2,t,i0_CPP2)
